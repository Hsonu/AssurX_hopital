    ...
    <header className="sticky top-0 z-50 bg-[#2D006B] border-b border-[#220052] shadow-md text-white" id="main-header">
      ...
      <div className="hidden lg:block max-w-[1400px] mx-auto px-4 md:px-6 py-3">
        ...
        <div className="flex items-center justify-between gap-2.5 xl:gap-3.5">
          ...
          {/* Branch Selector */}
          <div className="relative flex items-center gap-1.5 bg-white/10 border border-white/20 rounded-full px-2.5 py-1.5 hover:bg-white/15 transition-colors flex-shrink-0">
          ...
          {/* Search Bar */}
          <div className="flex-1 max-w-[200px] xl:max-w-[260px] relative flex-shrink-1">
          ...
          {/* Navigation Links */}
          <nav className="flex items-center gap-3 xl:gap-4.5 text-xs font-bold uppercase tracking-wider text-white/80 flex-shrink-0">
            <button
              onClick={() => handleTabClick('home')}
              className={`hover:text-white transition-colors py-1 cursor-pointer whitespace-nowrap ${currentTab === 'home' ? 'text-white border-b-2 border-red-500 font-black' : ''}`}
            >
              Home
            </button>
            <button
              onClick={() => handleTabClick('scans')}
              className={`hover:text-white transition-colors py-1 cursor-pointer whitespace-nowrap ${currentTab === 'scans' ? 'text-white border-b-2 border-red-500 font-black' : ''}`}
            >
              Sonography
            </button>
            <button
              onClick={() => handleTabClick('labs')}
              className={`hover:text-white transition-colors py-1 cursor-pointer whitespace-nowrap ${currentTab === 'labs' ? 'text-white border-b-2 border-red-500 font-black' : ''}`}
            >
              Labs
            </button>
            <button
              onClick={() => handleTabClick('packages')}
              className={`hover:text-white transition-colors py-1 cursor-pointer whitespace-nowrap ${currentTab === 'packages' ? 'text-white border-b-2 border-red-500 font-black' : ''}`}
            >
              Packages
            </button>
            <button
              onClick={() => handleTabClick('bookings')}
              className={`hover:text-white transition-colors py-1 cursor-pointer whitespace-nowrap ${currentTab === 'bookings' ? 'text-white border-b-2 border-red-500 font-black' : ''}`}
            >
              My Bookings
            </button>
            <button
              onClick={() => handleTabClick('hiring')}
              className={`hover:text-white transition-colors py-1 cursor-pointer whitespace-nowrap ${currentTab === 'hiring' ? 'text-white border-b-2 border-red-500 font-black' : ''}`}
            >
              Careers
            </button>
          </nav>
          ...
          <div className="flex items-center gap-2 xl:gap-2.5 flex-shrink-0">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-wider transition-all cursor-pointer flex-shrink-0 whitespace-nowrap ${currentTab === 'admin'
