...
export default function DirectBookModal({
  ...
  const handleBookAndPayAtLab = async (e?: React.FormEvent, bypassedUser?: any) => {
    ...
    let orderId = "";
    try {
      setSubmitStep("Creating secure payment order...");
    ...
    const options = {
      ...
      handler: async function (response: any) {
        try {
          setSubmitStep("Verifying payment signature with bank server...");
            ...
            <div className="space-y-6 text-left animate-fade-in" id="printable-receipt-panel-direct">
              ...
              <div className="text-center space-y-2 border-b border-slate-100 pb-5">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2">
                  ...
                  <a
                    href={getWhatsAppUrl(selectedBranch, `Hello AssurX! My Booking ID is ${createdBooking.bookingId} and I have a query 😊`)}
                    target="_blank"
                  ...
                  >
                    ...
                    <span>WhatsApp {getBranchWhatsAppNumber(selectedBranch)} 😊</span>
                  </a>
                </div>
              </div>
